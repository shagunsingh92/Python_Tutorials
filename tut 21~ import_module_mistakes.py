...
# The following code returns the path which the python interpreter follows in order to find a module
# import sys
# print(sys.path)
...
# don't keep spaces in the file names as if you want to import the file somewhere else it will thorw an error