...
10. @classmethods can be used as an alternative constructor. the syntax for it is as follows:
                @classmethod
    ...
    Note: After the above step one need not to use a constructor to initialise instance variables
